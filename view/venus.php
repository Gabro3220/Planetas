...
echo "<h1>";
echo $venus->venus[0][0];
echo "</h1>";
echo "<br>";
echo "<p>";
echo $venus->venus[1][0];
echo "</p>";
echo "<p>";
echo "<h1>";
echo $venus->venus[2][0];
echo "</h1>";
echo "</p>";
echo "<p>";
echo $venus->venus[3][0];
echo "<br>";
echo $venus->venus[3][1];
echo "<br>";
echo $venus->venus[3][2];
echo "<br>";
echo $venus->venus[3][3];
echo "<br>";
echo $venus->venus[3][4];
echo "<br>";
echo $venus->venus[3][5];
echo "<br>";
echo $venus->venus[3][6];
echo "</p>";
echo "</div>";
echo "<div id='planetas'>";
echo "<img src=img/venus2.jpg>" . $venus->venus[4][0];
echo "</div>"
...
<!-- <div id="ali_texto">
    ...
    <div id="planetas">
    <img src="../view/img/venus2.png" alt="">
</div> -->
<?php
